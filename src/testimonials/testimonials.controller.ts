...
export class TestimonialsController {
  ...
  @UseGuards(AuthGuard)
  @JwtType(JwtProcessorType.HMAC) // Enforce HMAC algorithm for JWT verification
  @ApiOperation({
  ...
  async getCount(): Promise<number> {
    ...
    try {
      ...
      this.logger.error('Error fetching testimonial count', error.stack);
      throw new Error('Unable to fetch testimonial count at this time.');
    }
  }
}
